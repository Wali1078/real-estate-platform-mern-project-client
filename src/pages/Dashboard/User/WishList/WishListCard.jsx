...
const WishListCard = ({wishlist}) => {
    ...
    const {_id,oldId,userName,userEmail,title,image,location,priceRangeStart,priceRangeEnd,verificationStatus,agentName,agentImg,desc} = wishlist || {}
  return (
    <div>
        ...
        <div className="text-center pb-5">
         <Link to={`/property-details/${_id}`}> <button
            type="button"
