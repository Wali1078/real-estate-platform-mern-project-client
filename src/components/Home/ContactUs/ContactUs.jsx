                ...
                <form className="mt-12">
                    <div className="-mx-2 md:items-center md:flex">
                        ...
                        <div className="flex-1 px-2 mt-4 md:mt-0">
                            ...
                            <input type="email" placeholder="Your Email Address" className="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                        </div>
                    </div>
                    ...
                    <button onClick={(e)=>e.preventDefault()} className="w-full px-6 py-3 mt-4 text-sm rounded-md  border-2 border-slate-400  font-medium text-slate-400 shadow-md transition duration-150 ease-in-out hover:bg-slate-400 hover:text-white hover:shadow-lg focus:outline-none focus:ring-0 active:bg-slate-600">
                        Get in Touch
                    </button>
                </form>
            </div>
                ...
                <div className="mt-6 space-y-8 md:mt-8">
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">
                            Abdul Shokoor Amini, Ansari Avenue
                    ...
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">(+7) 705 131 66 92</span>
                    </p>
                    ...
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">Shokoor@gmail.com</span>
                    </p>
                </div>
